...
alarm_app_name       = "bef-File-Storage-candidate"
alarm_thresholds = {
  info_error_rate            = 10
  warn_error_rate            = 15
...
#Lambda
bef-presigned-url-lambda-function-name    = "bef-presigned-url-candidate"
...
#S3
bef_bucket_name              = "bef-storage-candidate"
...
#KMS
presigned-url-kms-name = "bef-presigned-url-kms-candidate"

# VPC
vpc_name_prefix         = "presigned-url-candidate"
vpc_security_group_name = "presigned-url-sg-sandidate"